...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/boto3_type-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12828&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/boto3_type-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `boto3_type` can be installed with:

```
conda install boto3_type
```

It is possible to list all of the versions of `boto3_type` available on your platform with:
